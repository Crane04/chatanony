import faceEmojis from "../Utils/face-emojis";


const Messages = ({messages, page,  Reply}) => {
  ...
  return (
   ...
   return  <div className="unit-message" key={index}>
                  ...
                  <div className="msg">
                      ...
                      {
                        replied ?
                        <div className="msg-reply">{replied}</div> :
                        ""
                      }
                  ...
                  <button onClick={() => {Reply(message ? message : "image")}}>
